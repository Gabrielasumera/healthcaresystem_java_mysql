...
public class Appointment
{
    ...
    /***********************************************************************************************/
    //return doctor Fees
    public int GetDoctorFees(int docID)
    {
        int  DoctorFees = 0;
        try
        {
    ...
    /***********************************************************************************************/
    public String GetDoctorQualification(int docID)
    {
    ...
    public void generateAppointment()//This Method Add all details into appointment table of EHMS Database
    {
...

        {
            ...
            String problem = "Ear_infection";
            int Pid = 4;
            String Doctor_Name = "Nathan";
            String Doctor_Qualification = "Doctor of Medicine";
            String Doctor_Type = "Ear";
            int docFees = 400;
            int payment_status = 1;
            String Appointment_Status = "Payed";


            st.executeUpdate("INSERT INTO Appointments VALUES ('" + 3 + "','" + problem + "','" + Pid + "','" + Doctor_Name + "','" + 1 + "','" + Doctor_Type + "','" + Doctor_Qualification + "','" + docFees + "','" + payment_status + "','" + Appointment_Status + "')");
            System.out.println("ThankYou For visiting us your Appointment Has Been confirmed!!!");
